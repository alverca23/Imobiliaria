...
namespace DataAccessLayer
{
    public class DAL
    {
        ...
        public DAL()
        {
            _SqlConn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=" + System.Windows.Forms.Application.StartupPath + @"\db.mdf;Integrated Security=True;Connect Timeout=30");
        }
